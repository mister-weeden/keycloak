...
[source,bash,subs="attributes+"]
----
kubectl create -f https://raw.githubusercontent.com/mister-weeden/keycloak-quickstarts/refs/heads/main/kubernetes/keycloak.yaml
----
...
[source,bash,subs="attributes+"]
----
wget -q -O - https://raw.githubusercontent.com/mister-weeden/keycloak-quickstarts/refs/heads/main/kubernetes/keycloak-ingress.yaml | \
